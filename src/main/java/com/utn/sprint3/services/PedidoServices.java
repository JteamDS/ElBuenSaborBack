...
public interface PedidoServices extends BaseServices<Pedido,Long> {
    ...
    List<Pedido> buscarEstado(DtoCambioEstado dtoCambioEstado) throws Exception;
    Pedido cambiarEstado(DtoCambioEstado dtoCambioEstado) throws Exception;
    Factura crearFactura(DtoFactura dtoFactura) throws Exception;
    String verGanancias() throws Exception;
}
